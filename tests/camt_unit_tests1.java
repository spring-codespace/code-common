...
class Camt054V02GeneratorTest {
    ...
    void createDocumentSuccess() throws Exception {
        ...
        // Create a custom generator with mocked mapper for testing
        Camt054V02Generator testGenerator = new Camt054V02Generator(reportDataV02Mapper) {
            @Override
            protected JAXBElement<Document> createDocument(List<ReportData> data, ReportContext context) {
                // Call the mapper directly with our mock
                var genericNotif = reportDataV02Mapper.createBankNotification(data, context);
                var mappedNotif = bankToCustomerMapper.mapToCamt054V02(genericNotif);
                
                // Mock ObjectFactory behavior
                ObjectFactory factory = new ObjectFactory();
                Document doc = factory.createDocument().withBkToCstmrDbtCdtNtfctn(mappedNotif);
        ...
        // Execute
        assertDoesNotThrow(() -> {
            testGenerator.createDocument(reportData, context);
        });
    ...
    void createDocumentNullInput() throws Exception {
        ...
        // Note: This might throw NullPointerException depending on ObjectFactory implementation
        assertDoesNotThrow(() -> {
            try {
                ...
                // Expected if ObjectFactory doesn't handle null gracefully
                assertTrue(e.getCause() instanceof NullPointerException || 
                          e instanceof java.lang.reflect.InvocationTargetException);
            }
        });
        
        verify(reportDataV02Mapper).createBankNotification(null, null);
    }
